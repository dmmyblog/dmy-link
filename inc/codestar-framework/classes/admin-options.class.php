...
if (!class_exists('CSF_Options')) {
  class CSF_Options extends CSF_Abstract
  {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => '大绵羊外链跳转插件 <small></small>',
      'framework_class'         => '',
    ...
    public function add_options_html()
    {
      ...
      if ($has_nav) {
        ...
        echo '<div class="csf-nav csf-nav-options dmy-nav-options">';
        ...
        foreach ($this->pre_tabs as $tab) {
          ...
          if (!empty($tab['subs'])) {
            ...
            echo '<li class="csf-tab-item dmy-tab-item">';
            ...
            echo '<li class="csf-tab-item dmy-tab-item"><a href="#tab=' . esc_attr($tab_id) . '" data-tab-id="' . esc_attr($tab_id) . '">' . $tab_icon . $tab['title'] . $tab_error . '</a></li>';
          }
        }
